...
setup(
    ...
    entry_points={
        'console_scripts': [
	'publisher=your_package_name.publisher:main',
	'subscriber=your_package_name.subscriber:main',
	'sample=your_package_name.sample:main',	#do not add your launch file name, else it wont be executable if you do so. just add a random name (`sample` here)
        ],
    },
)
